...
/**
 * Add foreign key indexes on KnowledgeItemRelation table
 *
 * Creates indexes on foreign key columns in the knowledge_item_relations table
 ...
 */
export class AddForeignKeyIndexes1766520000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Create index on knowledge_item_id foreign key
    ...
    // Create index on parent_id foreign key
